...
#Außreißer entfernen
merged_df = merged_df.drop(merged_df[merged_df.kWhDelivered >=108.4].index, axis=0) #Akutelle Elektroautos können maximal 108.4 kWh laden. Alles darüber hinaus wird aussortiert.
